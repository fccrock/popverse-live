          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none rounded-xl border border-white/[0.08] bg-[#0a0c14] pl-3 pr-8 py-2 text-sm font-semibold text-zinc-300 outline-none focus:border-violet-500/40 transition cursor-pointer"
              >
                {sortOptions.map(opt => (
                  <option key={opt.value} value={opt.value} style={{ background: "#0a0c14", color: "#d4d4d8" }}>Sort: {opt.label}</option>
                ))}
              </select>
              <svg className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="appearance-none w-full rounded-xl border border-white/[0.08] bg-[#0a0c14] pl-4 pr-8 py-2.5 text-sm font-semibold text-zinc-200 outline-none focus:border-violet-500/40 transition cursor-pointer"
                    >
                      <option value="" style={{ background: "#0a0c14", color: "#d4d4d8" }}>All Languages</option>
                      {Object.entries(tmdbLanguages).map(([code, name]) => (
                        <option key={code} value={code} style={{ background: "#0a0c14", color: "#d4d4d8" }}>{name}</option>
                      ))}
                    </select>
                    <svg className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 h-3.5 w-3.5 text-zinc-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                    </svg>
                  </div>
                </div>
